...
export const stories: Story[] = [
  {
    ...
    photos: 320,
    duration: "Journée",
    sessionType: "Mariage civil",
    delivery: "Livré en 12 jours",
    ...
    paragraphs: [
      ...
      "Au déjeuner, j'ai photographié au fil de la journée sans interrompre personne. Galerie livrée douze jours plus tard, classée par moment, prête à partager avec la famille.",
    ],
    images: [
    ...
    result:
      "320 photos livrées en 12 jours, classées par moment, dans une galerie privée partagée avec les proches.",
  },
  {
    ...
    photos: 35,
    duration: "1 heure",
    sessionType: "Portrait professionnel",
    ...
    paragraphs: [
      ...
      "Livraison sous une semaine, avec une sélection au format carré et vertical pour les réseaux. Thomas avait son site à jour le lendemain.",
    ],
    images: [
    ...
    result:
      "35 photos livrées en 7 jours, avec des formats dédiés au site, à LinkedIn et à la presse.",
  },
  {
    ...
    paragraphs: [
      ...
      "Une heure de séance, livrée sous deux semaines dans une galerie privée qu'ils ont partagée avec leurs proches.",
    ],
    images: [
    ...
    result:
      "80 photos livrées en 14 jours, dans une galerie privée, prêtes à imprimer et à partager.",
  },
  {
    ...
    sessionType: "Reportage famille",
    delivery: "Livré en 21 jours",
    ...
    paragraphs: [
      ...
      "Livré en trois semaines, classé par moment, avec une sélection prête à imprimer pour les albums de famille.",
    ],
    images: [
    ...
    result:
      "160 photos livrées en 21 jours, classées par moment, avec une sélection prête à imprimer.",
  },
];
